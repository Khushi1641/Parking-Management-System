...
<section id="main-content">
	<section class="wrapper">
        ...
        $qry="SELECT * from security_tbl WHERE security_id='$security_id'";
             ...
             <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                <form role="form" action="updatesecurity.php" method="POST">
                                <input type="hidden" name="security_id" value="<?php echo $row['security_id'];?>">

                                <div class="form-group">
                                    <label for="exampleInputEmail1">Security Question</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="security Question" name="security_question" value="<?php echo $row['security_question'];?>">
