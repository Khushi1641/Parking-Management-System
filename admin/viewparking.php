...
$qry = "SELECT * FROM parking_tbl WHERE Isactive=1 or Isactive=0";
...
?>
    ...
    <?php
        ...
        <tr>
            ...
            <td><a href="parkingstatus.php?parking_id=<?php echo $row['parking_id']?>">Change</a></td>
            <td><a href="deleteparking.php?parking_id=<?php echo $row['parking_id']?>">Delete</a></td>
