 ...
 <div class="panel panel-default">
    ...
    <div>
      <table class="table">
        ...
        $qry = "SELECT * FROM service_tbl WHERE Isactive=1 or Isactive=0";
    ...
    <?php
        ...
        <tr>
            ...
            <td> <a href="servicestatus.php?service_id=<?php echo $row['service_id']?>">Change</a></td>
            <td> <a href="editservice.php?service_id=<?php echo $row['service_id']?>">Edit</a></td>
            <td> <a href="deleteservice.php?service_id=<?php echo $row['service_id']?>">Delete</a></td>
