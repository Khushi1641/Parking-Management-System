             ...
             <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                <form role="form" action="insertslot.php" method="POST">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Vehicle Type</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="St id" name="vehicle_type">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Slot Name</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="st name" name="slot_name">
                                </div>
                                <div class="form-group">
