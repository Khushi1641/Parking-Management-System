             ...
             <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                <form role="form" action="insertguard.php" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="exampleInputEmail1">Mobile num</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="mobilenum" name="mobilenum">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="usertype" name="usertype">
                                </div>
