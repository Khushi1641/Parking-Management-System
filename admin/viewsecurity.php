    ...
    <div>
      <table class="table">
        <thead>
            ...
            $qry = "SELECT * FROM security_tbl WHERE Isactive=1 or Isactive=0";
    ...
    <?php
        if(mysqli_num_rows($rs)>0)
        {
            while($row=mysqli_fetch_assoc($rs))
            {
                ...
                ?>  
        <tr>
            <td><?php echo $row['security_id'];?></td>
            <td><?php echo $row['security_question'];?></td>
            <!-- <td><?php echo $row['security_answer'];?></td> -->
            <td><?php echo $row['Isactive'];?></td>
            <td> <a href="securitystatus.php?security_id=<?php echo $row['security_id']?>">Change</a></td>
            <td> <a href="editsecurity.php?security_id=<?php echo $row['security_id']?>">Edit</a></td>
            <td> <a href="deletesecurity.php?security_id=<?php echo $row['security_id']?>">Delete</a></td>
