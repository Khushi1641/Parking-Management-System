 ...
 <div class="panel panel-default">
    ...
    <div>
      <table class="table">
        ...
        $qry = "SELECT * FROM slot_tbl WHERE Isactive=1 or Isactive=0";
    ...
    <?php
        ...
        <tr>
            ...
            <td><a href="slotstatus.php?slot_id=<?php echo $row['slot_id']?>">Change</a></td>
            <td><a href="editslot.php?slot_id=<?php echo $row['slot_id']?>">Edit</a></td>
            <td><a href="deleteslot.php?slot_id=<?php echo $row['slot_id']?>">Delete</a></td>
