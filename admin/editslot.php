             ...
             <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                <form role="form" action="updateslot.php" method="POST">
                                <input type="hidden" name="slot_id" value="<?php echo $row['slot_id'];?>">

                                <div class="form-group">
                                    <label for="exampleInputEmail1">Vehicle Type</label>
                                    <input type="text" class="form-control" id="exampleInputEmail" name="vehicle_type" value="<?php echo $row['vehicle_type'];?>">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Slot Name</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1" name="slot_name" value="<?php echo $row['slot_name'];?>">
                                </div>
                                 <div class="form-group">
