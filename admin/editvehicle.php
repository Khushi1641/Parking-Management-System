             ...
             <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                <form role="form" action="updatevehicle.php" method="POST">
                                    <input type="hidden" name="id" value="<?php echo $row['vehicle_id'];?>">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Vehicle Type</label>
                                    <input type="t,ext" class="form-control" id="exampleInputEmail1" name="vehicle_type" value="<?php echo $row['vehicle_type'];?>">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Vehicle Number</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1" name="vehicle_number" value="<?php echo $row['vehicle_number'];?>">
                                </div>
                                <!-- <div class="form-group">
