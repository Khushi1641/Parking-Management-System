...
$qry = "SELECT * FROM guard_tbl WHERE Isactive=1 or Isactive=0";
...
?>
    ...
    <?php
        ...
        <tr>
            ...
            <td><a href="guardstatus.php?id=<?php echo $row['id']?>">Change</a></td>
            <td><a href="editguard.php?id=<?php echo $row['id']?>">Edit</a></td>
            <td><a href="deleteguard.php?id=<?php echo $row['id']?>">Delete</a></td>
