             ...
             <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                <form role="form" action="insertvehicle.php" method="POST">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Vehicle Type</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1" name="vehicle_type">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Vehicle Number</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1" name="vehicle_number">
