...
<section id="main-content">
 ...
 <div class="panel panel-default">
    ...
    $qry = "SELECT * FROM vehicle_tbl WHERE Isactive=1 or Isactive=0";
    ...
    <?php
        ...
        <tr>
            ...
            <td><a href="vehiclestatus.php?vehicle_id=<?php echo $row['vehicle_id']?>">Change</a></td>
            <td><a href="editvehicle.php?vehicle_id=<?php echo $row['vehicle_id']?>">Edit</a></td>
            <td><a href="deletevehicle.php?vehicle_id=<?php echo $row['vehicle_id']?>">Delete</a></td>
