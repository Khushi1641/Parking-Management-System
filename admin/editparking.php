             ...
             <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                ...
                                <form role="form" action="updateparking.php" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    if(mysqli_num_rows($rs))
                                    {
                                        while($row=mysqli_fetch_assoc($rs))
                                        {
                                            echo $row['slot_name'];
                                    ?>
                                        <option value="<?php echo $row['slot_name']; ?>"><?php echo $row['slot_name']; ?></option>
                                    <?php
                                        }
                                    }
                                    ?>  
                                ...
                                <input type="submit" name="submit" class="btn btn-info" name="submit">
                            </form>
                            </div>
